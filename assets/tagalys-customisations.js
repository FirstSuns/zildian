      ...
      widget: {
        ...
        render: function (html, args) {
          ...
          if (props.products.length > 0) {
            ...
            `;
          } else if (document.querySelector('.search-modal__form .search__input').value == '') {
            return html``;
          } else {
            return html`
            <div ref=${props.tagalysSearchSuggestionsPopoverRef} style=${style} class="search-suggestions">
              <div class="container">
                <p class="empty" style="padding: 20px;padding-top: 0;" >Sorry can't find a product</p>
              </div>
            </div>
          `;
          }
  ...
  setTimeout(() => {
    Tagalys.UIWidgets.Recommendations.init(
      "[data-recommendation='similar-products']",
      {
        ...
        // productId: '8328211530020',
        productId: window.pdp_product_id,
        templates: {
          header: {
            render: function (html, args) {
              var props = args.props
